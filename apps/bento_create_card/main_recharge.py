...
from tools_me.bento_token import GetToken, cut_list
...
def web_hook():
    ...
    data = {
            'businessId': 30076,
            'url': 'https://www.trybest.top/admin/bento/',
        }
...
def web_list():
    ...
    url = "https://api.bentoforbusiness.com/webhooks/3003b0c8-0356-4b89-be0a-b93d328d38c4"
...
def test():
    url = "https://www.trybest.top/admin/bento/"
    resp = requests.post(url, data='dsfasdfa', verify=True)
    print(resp.text)


if __name__ == "__main__":
    RechargeCard().one_alias('Tyrone Galen')
