...
bentodata_blueprint = Blueprint('bentodata', __name__, url_prefix='/475440', template_folder='../wrong')

verify_pay_blueprint = Blueprint('verify_pay', __name__, url_prefix='/verify_pay', template_folder='../templates')

finance_blueprint = Blueprint('finance', __name__, url_prefix='/finance', template_folder='../wrong')

study_blueprint = Blueprint('study', __name__, url_prefix='/study', template_folder='../wrong')

index_blueprint = Blueprint('/', __name__, url_prefix='/', template_folder='../wrong')
